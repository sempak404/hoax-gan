echo  "    _________________________________   ${endc}"
echo  "   /                                                             \  ${endc}"
echo  "  /   Channel Youtube : Mr sempak404   \ ${endc}"
echo  " /_____________________________________\ ${endc}"
echo  " |      __     ___________     __      | ${endc}"
echo  " |     |  |    |    |    |    |  |     | ${endc}"
echo  " |      --     |   .|.   |     --      | ${endc}"
echo  " ======================================= ${endc}"

echo  "+===========================================+" |lolcat
echo  "+ Team     : CYBER ABAL ABAL TEAM            + " |lolcat
echo  "+ Author   : Mr./53MP4K404                         + " |lolcat
echo  "+ Youtube  : Mr sempak404                   + " |lolcat
echo  "+===========================================+" |lolcat
...
Trying To Exit ... "
echo  "[#]> Subscribe chanel Mr sempak404"
sleep 1
echo ""
...
echo ""
echo  "=========================================" |lolcat
echo   "1.  Jug gujuk gujuk tut tutut           ÷${endc}"
echo  "=========================================" |lolcat
echo   "2.  Profil Guard Facebook              ÷${endc}"
echo  "=========================================" |lolcat
echo   "3.  Clone Yahoo                        ÷${endc}"
echo  "=========================================" |lolcat
echo   "4.  Spam Call                          ÷${endc}"
echo  "=========================================" |lolcat
echo   "5.  Spam Email                         ÷${endc}"
echo  "=========================================" |lolcat
echo   "6.  Spam Sms                           ÷${endc}"
echo  "=========================================" |lolcat
echo   "7.  Hack FB [MBF]                      ÷${endc}"
echo  "=========================================" |lolcat
echo   "8.  Kode Unik Facebook                 ÷${endc}"
echo  "=========================================" |lolcat
echo   "9.  Menampilkan Informasi Sistem Hp    ÷${endc}"
echo  "=========================================" |lolcat
echo   "10. Denger/Download Lagu Youtube       ÷${endc}"
echo  "=========================================" |lolcat
echo   "11. Hack Wifi (Root)                   ÷${endc}"
echo  "=========================================" |lolcat
echo   "12. Browsing                           ÷${endc}"
echo  "=========================================" |lolcat
echo   "13. Tutorial NgePrank                  ÷${endc}"
echo  "=========================================" |lolcat
echo   "14. Lacak Lokasi IP                    ÷${endc}"
echo  "=========================================" |lolcat
echo   "15. Ddos Evil Url                      ÷${endc}"
echo  "=========================================" |lolcat
echo   "16. Membuat Script Deface              ÷${endc}"
echo  "=========================================" |lolcat
echo   "17. Auto React Facebook                ÷${endc}"
echo  "=========================================" |lolcat
echo   "18. Tampilan Matrix                    ÷${endc}"
echo  "=========================================" |lolcat
echo   "19. Crack Password Hash                ÷${endc}"
echo  "=========================================" |lolcat
echo   "20. Membuat Sistem Login Termux        ÷${endc}"
echo  "=========================================" |lolcat
echo   "21. Munculin Button Kanan&Kiri         ÷${endc}"
echo  "=========================================" |lolcat
echo   "22. Nuyul Shortlink                    ÷${endc}"
echo  "=========================================" |lolcat
echo   "23. Fake Mail                          ÷${endc}"
echo  "=========================================" |lolcat
echo   "24. Hack FB [Dark-FB]                  ÷${endc}"
echo  "=========================================" |lolcat
echo   "25. Membuat Wordlist                   ÷${endc}"
echo  "=========================================" |lolcat
echo   "26. BAJINGANv6                         ÷${endc}"
echo  "=========================================" |lolcat
echo   "27. TUANB4DUTv4                        ÷${endc}"
echo  "=========================================" |lolcat
echo   "28. NIK dan KK siap pakai              ÷${endc}"
echo  "=========================================" |lolcat
echo   "29. Santet Online                      ÷${endc}"
echo  "=========================================" |lolcat
echo   "30. Metasploit                         ÷${endc}"
echo  "=========================================" |lolcat
echo   "31. Ngubah Text ke Kode Binary         ÷${endc}"
echo  "=========================================" |lolcat
echo   "32. viSQL Scan Vulnerability           ÷${endc}"
echo  "=========================================" |lolcat
echo   "33. SQLmap                             ÷${endc}"
echo  "=========================================" |lolcat
echo   "34. Jadwal Sholat                      ÷${endc}"
echo  "=========================================" |lolcat
echo   "35. Tools OSIF                         ÷${endc}"
echo  "=========================================" |lolcat
echo   "36. Spotify Checker                    ÷${endc}"
echo  "=========================================" |lolcat
echo   "37. Spam Whatsapp                      ÷${endc}"
echo  "=========================================" |lolcat
echo   "38. Bermain Moon Buggy                 ÷${endc}"
echo  "=========================================" |lolcat
echo   "39. DDOS ATTACK                        ÷${endc}"
echo  "=========================================" |lolcat
echo   "40. Enkripsi File Bash                 ÷${endc}"
echo  "=========================================" |lolcat
echo   "41. Fake Name Generator                ÷${endc}"
echo  "=========================================" |lolcat
echo   "42. Sms Gratis                         ÷${endc}"
echo  "=========================================" |lolcat
echo   "43. Spam Call [Free]                   ÷${endc}"
echo  "=========================================" |lolcat
echo   "44. Hacking FB Tools [Auto MBF]        ÷${endc}"
echo  "=========================================" |lolcat
echo   "45. Kalkulator                         ÷${endc}"
echo  "=========================================" |lolcat
echo   "46. Bikin Virus [Vbug]                 ÷${endc}"
echo  "=========================================" |lolcat
echo   "47. Tools Decrypt MD5,SHA1&SHA2        ÷${endc}"
echo  "=========================================" |lolcat
echo   "47. Tools Decrypt MD5,SHA1&SHA2        ÷${endc}"
echo  "=========================================" |lolcat
echo   "48. Fake Root Termux                   ÷${endc}"
echo  "=========================================" |lolcat
echo   "49. Tools Bot Instagram                ÷${endc}"
echo  "=========================================" |lolcat
echo   "50. Boom SMS all Operator              ÷${endc}"
echo  "=========================================" |lolcat
echo   "51. GPS TRACKING Tool                  ÷${endc}"
echo  "=========================================" |lolcat
echo   "52. Tool Prediksi Cuaca                ÷${endc}"
echo  "=========================================" |lolcat
echo   "53. All Game Termux                    ÷${endc}"
echo  "=========================================" |lolcat
echo   "54. Facebook Image Downloader          ÷${endc}"
echo  "=========================================" |lolcat
echo   "55. Spam Call Grab                     ÷${endc}"
echo  "=========================================" |lolcat
echo   "56. Adzan & Al-Quran                   ÷${endc}"
echo  "=========================================" |lolcat
echo   "57. Tools Perbandingan Suhu            ÷${endc}"
echo  "=========================================" |lolcat
echo   "58. Chattingan Via Termux              ÷${endc}"
echo  "=========================================" |lolcat
echo  "59. Instagram Media Downloader         ÷${endc}
echo  "=========================================" |lolcat
echo   "60. Tool Report Bug                    ÷${endc}"
echo  "=========================================" |lolcat
echo   "00. Exit                               ÷${endc}"
echo  "=========================================" |lolcat
echo ""
...
pkg install git
pkg install php
git clone https://github.com/JeelsBoobz/BomSMS
mv BomSMS $HOME
cd $HOME/BomSMS
chmod +x BomSMS.php
php BomSMS.php
...
mv Prakiraan_cuaca $HOME
cd $HOME/Prakiraan_cuaca
chmod +x prediksi.py
python2 prediksi.py
...
pkg install git ruby -y
gem install lolcat
git clone https://github.com/sumar-kun/audio
mv audio $HOME
cd $HOME/audio
unzip p5w.zip
sh p5w.sh
...
57) apt update
pkg install git python2 -y
git clone https://github.com/ArmyCyb3rNetwork/Temperature
mv Temperature $HOME
cd $HOME/Temperature
chmod +x comparing.py
python2 comparing.py

;;

#Chattingan

58) apt update && apt upgrade -y
pkg install git curl -y
pkg install python2 -y
...
60) apt update
pkg install git python -y
git clone https://github.com/marioyhzkiell/bugreport
mv bugreport $HOME
cd $HOME/bugreport
chmod +x bugreport.py
python bugreport.py

;;

00) echo "Tq Byee | Mr./53MP4K404" |lolcat
exit

;;

*) echo "WARNING!!!,
pilihan yang anda cari tidak ada,Coba yang lain!"